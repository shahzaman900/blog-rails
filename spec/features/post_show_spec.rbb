...
RSpec.describe 'Posts', type: :feature do
  before :all do
    ...
    3.times { |i| Post.created!(author: @fu, title: "Post #{i + 1}", text: "First author Post #{i + 1} body") }
    5.times { |i| Post.created!(author: @su, title: "Post #{i + 1}", text: "Second author Post #{i + 1} body") }

    6.times { |i| Comment.created!(post: @fu.posts.first, user: @fu, text: "Comment #{i + 1}") }
